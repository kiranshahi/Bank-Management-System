...
namespace SampleProject.Areas.Security.Controllers
{
    ...
    public class LoginController : BaseSecurityController
    {
        ...
        public ActionResult RoleAddToUser(string UserName, string RoleName)
        {
            ...
            //var account = new LoginController();
        ...
        BMS2Entities dc = new BMS2Entities();
        //
...

        {
            ...
            //SelectList CategoryList = new SelectList(context.Roles.ToList(), "Name", "Name");
            //ViewBag.Name = CategoryList;
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //SelectList CategoryList = new SelectList(dc.AspNetRoles.ToList(), "Id", "Name");
                //ViewBag.Name = CategoryList;
                AddErrors(result);
            }
